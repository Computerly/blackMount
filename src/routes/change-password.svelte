			...
			<form on:submit|preventDefault={login}>
				<div class="rows">
					...
					<div class="row">
						...
						<input type="password" id="password" name="password" bind:value={new_password} autocomplete="current-password">
					</div>
				<div class="errors">
					<ul>
